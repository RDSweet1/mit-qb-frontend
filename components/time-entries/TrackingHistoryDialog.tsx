      ...
      <div className="flex min-h-screen items-center justify-center p-4">
        ...
        <div className="relative bg-white rounded-xl shadow-2xl max-w-2xl w-full max-h-[80vh] overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-blue-600 to-blue-700 px-6 py-4 flex items-center justify-between">
            <div>
              <h2 className="text-xl font-bold text-white">Tracking History</h2>
              {entryDetails && (
                <p className="text-blue-100 text-sm mt-1">
                  {entryDetails.employee_name} • {entryDetails.txn_date} • {entryDetails.hours}h {entryDetails.minutes}m
                </p>
              )}
            </div>
            <button
